...
public class Country2Controller implements Initializable {
    @FXML
    Label nameLabel, weightedPointsLabelMarket1, weightedPointsLabelMarket2, weightedPointsLabelMarket3, weightedPointsLabelComp1, weightedPointsLabelComp2, weightedPointsLabelComp3, totWeightedMarketPointsCountry2, totWeightedCompPointsCountry2;
    @FXML
    ...
    public void updateWeight(ActionEvent event) {
        ...
        totWeightedMarketPointsCountry2.setText(String.valueOf(df.format(sumMarket)));
        totWeightedCompPointsCountry2.setText(String.valueOf(df.format(sumComp)));

    }

    // Sets the criteria and weight entered from the criteria "page".
    public void setCriteria() {
            criteriaAreaMarket1.setText(model.get(1).getCriteria(0).getCriteria());
            weightFieldMarket1.setText(String.valueOf(model.get(1).getCriteria(0).getWeight()));

            criteriaAreaMarket2.setText(model.get(1).getCriteria(1).getCriteria());
            weightFieldMarket2.setText(String.valueOf(model.get(1).getCriteria(1).getWeight()));

            criteriaAreaMarket3.setText(model.get(1).getCriteria(2).getCriteria());
            weightFieldMarket3.setText(String.valueOf(model.get(1).getCriteria(2).getWeight()));

            criteriaAreaComp1.setText(model.get(1).getCriteria(3).getCriteria());
            weightFieldComp1.setText(String.valueOf(model.get(1).getCriteria(3).getWeight()));

            criteriaAreaComp2.setText(model.get(1).getCriteria(4).getCriteria());
            weightFieldComp2.setText(String.valueOf(model.get(1).getCriteria(4).getWeight()));

            criteriaAreaComp3.setText(model.get(1).getCriteria(5).getCriteria());
            weightFieldComp3.setText(String.valueOf(model.get(1).getCriteria(5).getWeight()));
    }

    // Sets/saves the criteria entered into our model (button on action)
    public void handleSaveFactors() {
        try {
            model.get(1).getCriteria(0).setFactors(pointsBoxMarket1.getValue(), Integer.parseInt(factFieldMarket1.getText()));
            weightedPointsLabelMarket1.setText(String.valueOf(df.format(model.get(1).getCriteria(0).getWeightedPoints())));

            model.get(1).getCriteria(1).setFactors(pointsBoxMarket2.getValue(), Integer.parseInt(factFieldMarket2.getText()));
            weightedPointsLabelMarket2.setText(String.valueOf(df.format(model.get(1).getCriteria(1).getWeightedPoints())));

            model.get(1).getCriteria(2).setFactors(pointsBoxMarket3.getValue(), Integer.parseInt(factFieldMarket3.getText()));
            weightedPointsLabelMarket3.setText(String.valueOf(df.format(model.get(1).getCriteria(2).getWeightedPoints())));

            totWeightedMarketPointsCountry2.setText(String.valueOf(df.format(model.get(1).getTotalMarketAttractiveness())));

            model.get(1).getCriteria(3).setFactors(pointsBoxComp1.getValue(), Integer.parseInt(factFieldComp1.getText()));
            weightedPointsLabelComp1.setText(String.valueOf(df.format(model.get(1).getCriteria(3).getWeightedPoints())));

            model.get(1).getCriteria(4).setFactors(pointsBoxComp2.getValue(), Integer.parseInt(factFieldComp2.getText()));
            weightedPointsLabelComp2.setText(String.valueOf(df.format(model.get(1).getCriteria(4).getWeightedPoints())));

            model.get(1).getCriteria(5).setFactors(pointsBoxComp3.getValue(), Integer.parseInt(factFieldComp3.getText()));
            weightedPointsLabelComp3.setText(String.valueOf(df.format(model.get(1).getCriteria(5).getWeightedPoints())));

            totWeightedCompPointsCountry2.setText(String.valueOf(df.format(model.get(1).getTotalMarketAttractiveness())));

            // If no country name has been entered don't change name to "blank"
            if (!countryNameField.getText().equals("")) {
                model.get(1).setCountry(countryNameField.getText());
                country2Button.setText(model.get(1).getCountry());
                viewController.getCountry1Controller().country2Button.setText(model.get(1).getCountry());
                viewController.getCountry3Controller().country2Button.setText(model.get(1).getCountry());
                viewController.getMacsFrameworkController().country2Button.setText(model.get(1).getCountry());
                viewController.getDashboardController().country2Button.setText(model.get(1).getCountry());
            }
        }
